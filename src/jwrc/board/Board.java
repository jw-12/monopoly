    ...
    public ArrayList<BoardSpace> generateSpaces() {
		return (
				new ArrayList<>(Arrays.asList(
					...
					new Sites("Oriental Avenue", 50, 6, "Blue", new int[]{2, 4, 10, 30, 90, 160, 250}, 100),
					new Chance(7),
					new Sites("Vermont Avenue", 50, 8, "Blue", new int[]{2, 4, 10, 30, 90, 160, 250}, 100),
					new Sites("Connecticut Avenue", 60, 9, "Blue", new int[]{2, 4, 10, 30, 90, 160, 250}, 100),
					new BlankSpace(10),
					new Sites("St. Charles Place", 70, 11, "Pink", new int[]{2, 4, 10, 30, 90, 160, 250}, 150),
					new Utility("Electric Company", 75, 12),
					new Sites("States Avenue", 70, 13, "Pink", new int[]{2, 4, 10, 30, 90, 160, 250}, 150),
					new Sites("Virginia Avenue", 80, 14, "Pink", new int[]{2, 4, 10, 30, 90, 160, 250}, 150),
					new TransportSpaces("Pennsylvania Railroad", 100, 15),
					new Sites("St James Place", 90, 16, "Orange", new int[]{2, 4, 10, 30, 90, 160, 250}, 200),
					new CommunityChest(17),
					new Sites("Tennessee Avenue", 90, 18, "Orange", new int[]{2, 4, 10, 30, 90, 160, 250}, 200),
					new Sites("New York Avenue", 100, 19, "Orange", new int[]{2, 4, 10, 30, 90, 160, 250}, 200),
					new BlankSpace(20),
					new Sites("Kentucky Avenue", 110, 21, "Red", new int[]{2, 4, 10, 30, 90, 160, 250}, 250),
					new Chance(22),
					new Sites("Indiana Avenue", 110, 23, "Red", new int[]{2, 4, 10, 30, 90, 160, 250}, 250),
					new Sites("Illinois Avenue", 120, 24, "Red", new int[]{2, 4, 10, 30, 90, 160, 250}, 250),
					new TransportSpaces("B. & O. Railroad", 100, 25),
					new Sites("Atlantic Avenue", 130, 26, "Yellow", new int[]{2, 4, 10, 30, 90, 160, 250}, 300),
					new Sites("Ventnor Avenue", 130, 27, "Yellow", new int[]{2, 4, 10, 30, 90, 160, 250}, 300),
					new Utility("Water Works", 75, 28),
					new Sites("Marvin Gardens", 140, 29, "Yellow", new int[]{2, 4, 10, 30, 90, 160, 250}, 300),
					new GoToJail(30),
					new Sites("Pacific Avenue", 150, 31, "Green", new int[]{2, 4, 10, 30, 90, 160, 250}, 300),
					new Sites("North Carolina Avenue", 150, 32, "Green", new int[]{2, 4, 10, 30, 90, 160, 250}, 300),
					new CommunityChest(33),
					new Sites("Pennsylvania Avenue", 160, 34, "Green", new int[]{2, 4, 10, 30, 90, 160, 250}, 300),
					new TransportSpaces("Short Line", 100, 35),
					new Chance(36),
					new Sites("Park Place", 175, 37, "Purple", new int[]{2, 4, 10, 30, 90, 160, 250}, 300),
					new Penalties(38, 75, "Luxury Tax"),
					new Sites("BoardWalk", 200, 39, "Purple", new int[]{2, 4, 10, 30, 90, 160, 250}, 400)
				)
			)
		);
	}
